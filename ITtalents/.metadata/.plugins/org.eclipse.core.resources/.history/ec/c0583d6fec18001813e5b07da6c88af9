...
public class Demo {
	...
	System.out.println();
		for (int i = 0; i < 5; i++) {
			...
			agency.requestView(buyer,agency.getProperties().get(i),agency.getProperties().get(i).getAgent());
			agency.requestView(buyer,agency.getProperties().get(i+1),agency.getProperties().get(i+1).getAgent());
			agency.requestView(buyer,agency.getProperties().get(i+2),agency.getProperties().get(i+2).getAgent());
