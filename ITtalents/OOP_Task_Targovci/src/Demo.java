...
public class Demo {
	...
	public static void main(String[] args) {
		...
		SoleTrader t2=new SoleTrader("1","1",200);
		...
		for (int i = 0; i < 1; i++) {
			System.out.println(t3.getKiosks().get(i).getProducts().entrySet());
		}
		
		t2.makeOrder(c5, "Meso");
		t2.makeOrder(c4, "Konservi");
		t2.makeOrder(c4, "Krastavici");
		t2.makeOrder(c4, "Domati");
		t2.makeOrder(c4, "Podpravki");
		t2.makeOrder(c3, "Yabulki");
		t2.makeOrder(c1, "Riba");
